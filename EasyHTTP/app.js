...
// Get single post
// const post = http.get('http://jsonplaceholder.typicode.com/posts/1', function(err, post) {
//   if(err) {
//     console.log(err);
//   } else {
//     console.log(post);
...
// Update post
// http.put('http://jsonplaceholder.typicode.com/posts/2', data, function(err, post) {
//   if(err) {
//     console.log(err);
//   } else {
//     console.log(post);
